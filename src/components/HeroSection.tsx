...
function HeroSection() {
  return (
    ...
    <div
      className=" bg-black h-auto md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0">
      ...
      <div className="p-4 relative z-10 w-full text-center">
       ...
       from-neutral-50 to-neutral-400"
        ...
        <p
          className="mt-4 font-normal text-base md:text-lgtext-neutral-300 max-w-lg mx-auto"
